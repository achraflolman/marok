...
import { BookOpen, Timer, ListTodo, Calculator } from 'lucide-react';
...
import GradeCalculatorView from './tools/GradeCalculatorView';
...
const ToolsView: React.FC<ToolsViewProps> = (props) => {
  ...
  const toolComponents: { [key: string]: React.ReactNode } = {
    ...
    grade_calculator: <GradeCalculatorView {...props} />,
  };
  ...
  const toolNavItems = [
      ...
      { id: 'grade_calculator', label: props.t('grade_calculator'), icon: <Calculator /> },
  ];
